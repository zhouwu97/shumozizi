...
论文不是结果汇总报告。正文应围绕少量关键数学判断展开论证，而不是按 Q1/Q2/Q3/Q4/Q5 逐问罗列方法、参数和结果。
...
只有核心问题（`core_question=true`）才需要完整论证单元。普通问题只需在 answer map 中有当前结果和直接答案位置。
