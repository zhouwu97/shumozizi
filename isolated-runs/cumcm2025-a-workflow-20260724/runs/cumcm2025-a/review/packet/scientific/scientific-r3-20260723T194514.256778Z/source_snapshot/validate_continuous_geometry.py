...
def _score_with_radius(
    ...
    try:
        ...
        return core.score_solution(actions, missiles, targets, bracket_step=step)
    finally:
...
def main() -> int:
    ...
    for question, (filename, missiles) in configurations.items():
        ...
        upper = _score_with_radius(
            actions, missiles, dense_targets, core.CLOUD_RADIUS, 0.04
        )
        lower = _score_with_radius(
            actions, missiles, dense_targets, conservative_radius, 0.04
        )
        time_scores = {
        ...
        interval_width = float(
            upper["objective_missile_s"] - lower["objective_missile_s"]
        )
    ...
    payload = {
        ...
        "method": {
            ...
            "temporal_method": "event partition, grid bracketing, Brent root refinement",
            "temporal_steps_s": [0.08, 0.04, 0.02],
        },
        "questions": questions,
        "metrics": {
            "surface_cover_radius_upper_bound_m": cover_radius,
