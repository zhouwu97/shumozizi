...
ALIASES = {
    ...
    "feasible-region": "feasible-region-active-constraints",
    "active-constraints": "feasible-region-active-constraints",
    "timeline": "interval-event-timeline",
    "uncertainty-fan": "uncertainty-fan-threshold",
    "evidence-chain": "multi-panel-evidence-chain",
...
CJK_HINTS = {
    ...
    "可行域": "feasible-region-active-constraints",
    "活跃约束": "feasible-region-active-constraints",
    "事件时间线": "interval-event-timeline",
    "不确定性扇形": "uncertainty-fan-threshold",
    "联合证据链": "multi-panel-evidence-chain",
    "tpe": "rf-tpe-surface",
    "曲面": "rf-tpe-surface",
